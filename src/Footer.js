...
export default function GlobalFooter({ page = "default", leadsCount, user, onNavigate }) {
  ...
  const navLinks = [
    { label: "Home",      page: "landing", target: "landing" },
    { label: "Leads",     page: "leads",   target: "leads" },
    { label: "Analytics", page: "analytics", target: "analytics" },
    { label: "About",     page: "about",   target: "about" },
  ];
    ...
    <footer className={`gfooter${isDark ? " gfooter--dark" : ""}`}>
      ...
      <div className="gfooter-body">
        <div className="gfooter-brand">
          ...
          <p className="gfooter-tagline">
            Manage your sales pipeline efficiently. Track leads, close deals,
          ...
          <div className="gfooter-social">
            <a href="https://github.com/Prachi088" target="_blank" rel="noreferrer" className="gfooter-social-link" title="GitHub">
              <GitHubIcon className="gfooter-social-icon" />
            </a>
            <a href="https://linkedin.com/in/prachi-rajput-023985280" target="_blank" rel="noreferrer" className="gfooter-social-link" title="LinkedIn">
              <LinkedInIcon className="gfooter-social-icon" />
            </a>
          </div>
        </div>
            ...
            {navLinks.map((link) => (
              <li key={link.label}>
                <button
                  ...
                  onClick={() => handleNav(link.target || link.page)}
                >
                  {link.label}
                </button>
              </li>
      ...
      <div className="gfooter-bottom">
        <span className="gfooter-copy">© {year} CRM Lite. All rights reserved.</span>
